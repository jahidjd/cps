...
<head>
    <title> Create Order - Get Your Custom Quote for Photo Editing </title>
    <meta charset="utf-8">
    <meta name="csrf-token" content="wJtQd9ePoR4aGUTHJKq0CfmZrT4h5rnMhG8EGgVE">
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <!--Facebook Meta-->
    <meta property="og:url" content="http://order.theclippingpathservice.com/" />
    <meta property="og:type" content="Website" />
    <meta property="og:title" content="Create Order - Get Your Custom Quote for Photo Editing" />
    <meta property="og:description"
        content="Choose the service you would like to receive in our customized order platform. We respond faster and offer services as per your requirement." />
    <meta property="og:image" content="http://order.theclippingpathservice.com/assets/img/logo.png" />

    <!--Google Meta-->
    <meta name="title" content="Create Order - Get Your Custom Quote for Photo Editing" />
    <meta name="description"
        content="Choose the service you would like to receive in our customized order platform. We respond faster and offer services as per your requirement." />

    <!-- Global site tag (gtag.js) - Google Analytics -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-229890024-1"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
            function gtag(){dataLayer.push(arguments);}
            gtag('js', new Date());
    
            gtag('config', 'UA-229890024-1');
    </script>

    <link href="http://order.theclippingpathservice.com/assets/landing/css/bootstrap.css" rel="stylesheet">
    <link href="http://order.theclippingpathservice.com/assets/landing/css/style.css" rel="stylesheet">
    <link rel="icon" type="image/x-icon" href="http://order.theclippingpathservice.com/assets/img/favicon.png">
...
<body>
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
        <div class="container">
            <a class="navbar-brand" href="{{route('indexf')}}">
                <img src="http://order.theclippingpathservice.com/assets/landing/img/logo.png" alt="Logo"
                        ...
                        <ul class="nav nav-pills flex-column mb-auto">
                            ...
                            <li class="nav-link-item mb-0">
                                <button id="navimages" class="navBtn navBtn_3 nav-link" disabled data-id="3">
                                    ...
                                    <p class="ms-2 teb-title">UPLOAD IMAGES</p>
                                </button>
                            </li>
                ...
                <div class="col-lg-6">
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <div class="row mt-2 ">
                                                                        <div
                                                                            ...
                                                                            <div class="thumbnail view-more"
                                                                                data-modal-title="Clipping path, Medium">
                                                                                <img width="50px"
                                                                                    src="http://order.theclippingpathservice.com/uploads/product/1643101221-61efbc256f6ba.png">
                                                                                <div class="view-more-background"></div>
                                                                                <a href="" class="view-more-text small"
                                                                        ...
                                                                        <div class="col-auto">
                                                                            <div class="custom-control custom-radio">
                                                                                <input type="radio"
                                                                                    ...
                                                                                    name="clipping-path"
                                                                                    data-category="Clipping path"
                                                                                    data-price="{{$v->advance}}" data-name="Complex"
                    ...
                    <div id="upload" style="height: 100%;" class="mt-5">
                        <section class="px-2 mb-5">
                            ...
                            <h1 class="mt-4">How many of your images need to be edited?</h1>
                            <div class="d-flex container px-2 mt-5">
                                <div class="bottom d-flex flex-row">
                                    <div class="input-group mb-3">
                                        <button type="button" class="input-group-text subImage">-</button>
                                        <input type="text" name="no_of_edit_image" id="noOfEditImage"
                                            class="form-control image__count total-number no-of-edit-image text-center"
                                            value="1">
                                        <button type="button" class="input-group-text addImage">+</button>
                                    </div>
                                </div>
                            </div>
                            <h1 class="mt-4">Upload Your Images</h1>
                            <p>Here we have added a few options. By using those options you can upload your images
                                without any difficulties.</p>
                            <div class="mt-5">
                                <div class="bg-white">
                                    <ul class="nav nav-tabs nav-fill" id="myTab" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link orderImageType active" data-type="1"
                                                ...
                                                <div class="d-flex flex-column lh-lg"> <i class="fas fa-upload"></i>
                                                    <span>Computer</span> </div>
                                            </button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link orderImageType" data-type="2" data-itype="dropbox"
                                                id="faq_tab_2-tab" data-bs-toggle="tab" data-bs-target="#faq_tab_2"
                                                type="button" role="tab" aria-controls="faq_tab_2"
                                                aria-selected="false">
                                                <div class="d-flex flex-column lh-lg"> <i class="fab fa-dropbox"></i>
                                                    <span>Dropbox</span> </div>
                                            </button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link orderImageType" data-type="3"
                                                data-itype="we_transfer" id="faq_tab_3-tab" data-bs-toggle="tab"
                                                data-bs-target="#faq_tab_3" type="button" role="tab"
                                                aria-controls="faq_tab_3" aria-selected="false">
                                                <div class="d-flex flex-column lh-lg"> <i
                                                        class="fab fa-wikipedia-w"></i> <span>Wetransfer</span> </div>
                                            </button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link orderImageType" data-type="4" data-itype="add_link"
                                                id="faq_tab_4-tab" data-bs-toggle="tab" data-bs-target="#faq_tab_4"
                                                type="button" role="tab" aria-controls="faq_tab_4"
                                                aria-selected="false">
                                                <div class="d-flex flex-column lh-lg"> <i class="fas fa-link"></i>
                                                    <span>Add Link</span> </div>
                                            </button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link orderImageType" data-type="5"
                                                data-itype="upload_later" id="faq_tab_5-tab" data-bs-toggle="tab"
                                                data-bs-target="#faq_tab_5" type="button" role="tab"
                                                aria-controls="faq_tab_5" aria-selected="false">
                                                <div class="d-flex flex-column lh-lg"> <i class="far fa-hourglass"></i>
                                                    <span>Upload Later</span> </div>
                                            </button>
                                        </li>
                                    </ul>
                                    <div class="tab-content" id="myTabContent">
                                            ...
                                            <div class="row p-3 mt-5">
                                                <form id="fileUploadForm" method="POST" action=""
                                                    ...
                                                    <input type="hidden" name="_token"
                                                        value="wJtQd9ePoR4aGUTHJKq0CfmZrT4h5rnMhG8EGgVE">
                                                    <div class="form-group mb-3">
                                                        <input name="file" type="file" id="file"
                                                            class="form-control fileUploadImage">
                                                    </div>

                                                    <!--<div class="d-grid mb-3">
                                                        <button type="button" class="btn btn-primary fileUploadBtn">Upload</button>
                                                    </div>-->

                                                    <div class="form-group fileUploadProgressBar"
                                                        style="display: none;">
                                                        <div class="progress">
                                                ...
                                                <div class="mt-2">
                                                    <table class="table table-bordered">
                                                        <tbody class="sample-image-section"></tbody>
                                                    </table>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="tab-pane fade" id="faq_tab_2" role="tabpanel"
                                            ...
                                            <div class="p-3">
                                                <h4 class="pb-3">Dropbox</h4>
                                                <div class="form-group">
                                                    <label for="link">Add Your Link</label>
                                                    <textarea name="link[dropbox]" id="link" cols="30" rows="2"
                                                        class="form-control dropbox__link image__link__comment"
                                                        placeholder="Paste your link"></textarea>
                                                </div>

                                                <div class="form-group pt-2">
                                                    <label for="comment">Comment</label>
                                                    <textarea name="comment[dropbox]" id="comment" cols="30" rows="2"
                                                        class="form-control"
                                        ...
                                        <div class="tab-pane fade" id="faq_tab_3" role="tabpanel"
                                            ...
                                            <div class="p-3 mt-4">
                                                <h4 class="pb-3">Wetransfer</h4>
                                                <div class="form-group">
                                                    <label for="link">Add Your Link</label>
                                                    <textarea name="link[we_transfer]" id="link" cols="30" rows="2"
                                                        class="form-control we__link image__link__comment"
                                                        placeholder="Paste your link"></textarea>
                                                </div>

                                                <div class="form-group pt-2">
                                                    <label for="comment">Comment</label>
                                                    <textarea name="comment[we_transfer]" id="comment" cols="30"
                                        ...
                                        <div class="tab-pane fade" id="faq_tab_4" role="tabpanel"
                                            ...
                                            <div class="p-3">
                                                <h4 class="pb-3">Add Link</h4>
                                                <div class="form-group">
                                                    <label for="link">Add Your Link</label>
                                                    <textarea name="link[add_link]" id="link" cols="30" rows="2"
                                                        class="form-control add__link image__link__comment"
                                                        placeholder="Paste your link"></textarea>
                                                </div>

                                                <div class="form-group pt-2">
                                                    <label for="comment">Comment</label>
                                                    <textarea name="comment[add_link]" id="comment" cols="30" rows="2"
                                                        class="form-control"
                                                        placeholder="Your comment here.."></textarea>
                                                </div>
                                            </div>
                                        ...
                                        <div class="tab-pane fade" id="faq_tab_5" role="tabpanel"
                                            aria-labelledby="faq_tab_5-tab">
                                            <div class="p-3">
                                                <h4 class="pb-3">Upload Later</h4>
                                                <div class="form-group">
                                                    <label for="comment">Comment</label>
                                                    <textarea name="comment[upload_later]" id="comment" cols="30"
                                                        rows="2"
                                                        class="form-control later__comment image__link__comment"
                                                        placeholder="Your comment here.."></textarea>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div id="info" style="height: 100%;" class="mt-5">
                        <section class="px-2 mb-5">
    ...
    <script>
        ...
        $('body').on('click', '.navBtn', function (){
            ...
            if(state === 2) {
                $('.next__button').html('Add Images &raquo;');
            }
            ...
            if(seletcedMenu === 4){
                if($('#first_name').val().length > 0 && $('#last_name').val().length > 0 && $('#email').val().length > 0) {
                    ...
                    $.ajax({
                        ...
                        url: "http://order.theclippingpathservice.com/payment/now",
                        method: 'POST',
                        type: 'POST',
                        data: payFormData,
                        dataType: 'json',
        ...
        $(document).ready(function (){
            ...
            $('body').on('change', '.fileUploadImage', function (e){
                ...
                if(files.length > 0) {
                    ...
                    $.ajax({
                        ...
                        url: "http://order.theclippingpathservice.com/upload/file",
                        method: 'POST',
                        data: formData,
                        dataType: 'json',
                        cache: false,
            ...
            function checkUserInfo() {
                if($('#first_name').val().length > 0 && $('#last_name').val().length > 0 && $('#email').val().length > 0) {
                    $('.stepFour').html(' ');
                    $('.stepFour').addClass('tab-icon fa fa-check');
                    $('.order__recap__section').css('display', 'block');
                } else {
                    $('.order__recap__section').css('display', 'none');
                }
            }
            //----Step Checking Section----//
