...
#ignismyModal .modal-header{
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <div class="modal-header">
                          ...
                          <button type="button" class="btn-close backToIndex" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <div class="thank-you-pop">
                                <img src="{{url('Green-Round-Tick.png')}}" alt="">
                                <h1>Thank You!</h1>
                                <p>Your order is placed successfully and we will contact you soon</p>
                        ...
                        <div class="modal-footer">
                          ...
                          <button type="button" class="btn btn-primary backToIndex">OK</button>
                        </div>
                      </div>
                    </div>
                  </div>
                            ...
                            <div class="accordion" id="accordionExample">
                                @foreach ($price as $k=>$v)
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseOnes{{$k}}" class=" @if($v->service_id==$service_id) accordion-collapse collapse show @else accordion-collapse collapse @endif   "
                                                        ...
                                                        <div class="col">
                                                            <div class="card card-complexity my-2">
                                                                <div class="card-body">
                                                                    ...
                                                                    @if ($b->service_id == $v->service_id && $b->package=='simple')
                                                                    ...
                                                                    <div class="row mt-2 ">
                                                                        <div
                                                                            ...
                                                                            <div class="thumbnail">
                                                                                <img width="50px"
                                                                                    src="{{url('aminAsset/image/pricing/packageImage/',$b->thumb_image)}}" alt="{{$b->title}}">
                                                                            </div>
                                                                            <div class="thumbnail">
                                                                                <img width="50px"
                                                                                    src="{{url('aminAsset/image/pricing/packageImage/',$b->thumb_image)}}" alt="{{$b->title}}">
                                                                            ...
                                                                            <div class="thumbnail view-more"
                                                                                ...
                                                                                <a href="" class="view-more-text small"
                                                                                    ...
                                                                                    data-bs-target="#{{$v->title}}_{{$v->id}}">View
                                                                                    More</a>
                                                                                <!-- Modal -->
                                                                                <div class="modal fade" id="{{$v->title}}_{{$v->id}}"
                                                                                    tabindex="-1"
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <div class="modal-content">
                                                                                            ...
                                                                                            <div class="modal-body">
                                                                                                <div id="carouselExampleIndicators_simple_{{$v->id}}"
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <button
                                                                                                            type="button"
                                                                                                            data-bs-target="#carouselExampleIndicators_simple_{{$v->id}}"
                                                                                                            data-bs-slide-to="0"
                                                                                                            class="active"
                                                                                                            aria-current="true"
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <img src="{{url('aminAsset/image/pricing/packageImage/',$b->slider_image)}}" alt="{{$b->title}}"
                                                                                                                class="d-block w-100"
                                                                                                                alt="">
                                                                                                        </div>
                                                        ...
                                                        <div class="col">
                                                            <div class="card card-complexity my-2">
                                                                <div class="card-body">
                                                                    ...
                                                                    @if ($b->service_id == $v->service_id && $b->package=='complex')
                                                                    <div class="row mt-2 ">
                                                                        <div
                                                                            class="col thumbnails d-flex justify-content-between">
                                                                            <div class="thumbnail">
                                                                                ...
                                                                                <div class="modal fade" id="{{$v->title}}_{{$v->id}}"
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <div class="modal-content">
                                                                                            ...
                                                                                            <div class="modal-body">
                                                                                                <div id="carouselExampleIndicators_complex_{{$v->id}}"
                                                                                                    class="carousel slide"
                                                                                                    data-bs-ride="carousel">
                                                                                                    <div
                                                                                                        class="carousel-indicators">
                                                                                                        <button
                                                                                                            type="button"
                                                                                                            data-bs-target="#carouselExampleIndicators_complex_{{$v->id}}"
                                                                                                            data-bs-slide-to="0"
                                                                                                            class="active"
                                                                                                            aria-current="true"
                                                                                                            aria-label="Slide 1"></button>
                                                        ...
                                                        <div class="col">
                                                            <div class="card card-complexity my-2">
                                                                <div class="card-body">
                                                                    ...
                                                                    @if ($b->service_id == $v->service_id && $b->package=='advanced')
                                                                    <div class="row mt-2 ">
                                                                        <div
                                                                            class="col thumbnails d-flex justify-content-between">
                                                                            <div class="thumbnail">
                                                                                ...
                                                                                <div class="modal fade"
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <div class="modal-content">
                                                                                            ...
                                                                                            <div class="modal-body">
                                                                                                <div id="carouselExampleIndicators_advanced_{{$v->id}}"
                                                                                                    class="carousel slide"
                                                                                                    data-bs-ride="carousel">
                                                                                                    <div
                                                                                                        class="carousel-indicators">
                                                                                                        <button
                                                                                                            type="button"
                                                                                                            data-bs-target="#carouselExampleIndicators_advanced_{{$v->id}}"
                                                                                                            data-bs-slide-to="0"
                                                                                                            class="active"
                                                                                                            aria-current="true"
                                                                                                            aria-label="Slide 1"></button>
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <div
                                                                                                            class="carousel-item active">
                                                                                                            <img src="{{url('aminAsset/image/pricing/packageImage/',$b->slider_image)}}"
                                                                                                                class="d-block w-100"
                                                                                                                alt="{{$b->title}}">
                                                                                                        </div>
                                                        ...
                                                        <div class="col">
                                                            <div class="card card-complexity my-2">
                                                                <div class="card-body">
                                                                    ...
                                                                    @if ($b->service_id == $v->service_id && $b->package=='super_complex')
                                                                    <div class="row mt-2 ">
                                                                        <div
                                                                            class="col thumbnails d-flex justify-content-between">
                                                                            <div class="thumbnail">
                                                                                ...
                                                                                <div class="modal fade"
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <div class="modal-content">
                                                                                            ...
                                                                                            <div class="modal-body">
                                                                                                <div id="carouselExampleIndicators_super_complex_{{$v->id}}"
                                                                                                    class="carousel slide"
                                                                                                    data-bs-ride="carousel">
                                                                                                    <div
                                                                                                        class="carousel-indicators">
                                                                                                        <button
                                                                                                            type="button"
                                                                                                            data-bs-target="#carouselExampleIndicators_super_complex_{{$v->id}}"
                                                                                                            data-bs-slide-to="0"
                                                                                                            class="active"
                                                                                                            aria-current="true"
                                                                                                            aria-label="Slide 1"></button>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseOne{{$k}}" class=" @if($v->service_id==$service_id) accordion-collapse collapse show @else accordion-collapse collapse @endif "
                                                                    ...
                                                                    <div class="row mt-2 ">
                                                                        <div
                                                                            ...
                                                                            <div class="thumbnail view-more"
                                                                                ...
                                                                                <a href="" class="view-more-text small"
                                                                                    data-bs-toggle="modal"
                                                                                    data-bs-target="#simple_{{$v->id}}">View
                                                                                    More</a>
                                                                                <!-- Modal -->
                                                                                <div class="modal fade"
                                                                                    id="simple_{{$v->id}}" tabindex="-1"
                                                                                    aria-labelledby="exampleModalLabel"
                                                                                    aria-hidden="true">
                                                                                    <div
                                                                                        class="modal-dialog modal-xl modal-dialog-centered">
                                                                                        <div class="modal-content">
                                                                                            ...
                                                                                            <div class="modal-body">
                                                                                                <div id=""
                                                                                                    class="carousel slide carouselExampleIndicators_simple_complex_{{$v->id}}"
                                                                                                    data-bs-ride="carousel">
                                                                                                    <div
                                                                                                        class="carousel-indicators">
                                                                                                        <button
                                                                                                            type="button"
                                                                                                            data-bs-target=".carouselExampleIndicators_simple_complex_{{$v->id}}"
                                                                                                            data-bs-slide-to="0"
                                                                                                            class="active"
                                                                                                            aria-current="true"
                                                                                                            aria-label="Slide {{$v->id}}"></button>
                                                                                                        <button
                                                                                                            type="button"
                                                                                                            data-bs-target=".carouselExampleIndicators_simple_complex_{{$v->id}}"
                                                                                                            data-bs-slide-to="{{$v->id}}"
                                                                                                            class=""
                                                                                                            aria-current="true"
                                                                                                            aria-label="Slide {{$v->id}}"></button>
                                                                                                    </div>
                                                                    ...
                                                                    <div class="row mt-2 ">
                                                                        <div
                                                                            ...
                                                                            <div class="thumbnail view-more"
                                                                                ...
                                                                                <a href="" class="view-more-text small"
                                                                                    data-bs-toggle="modal"
                                                                                    data-bs-target="#complex_{{$v->id}}">View
                                                                                    More</a>
                                                                                <!-- Modal -->
                                                                                <div class="modal fade"
                                                                                    id="complex_{{$v->id}}" tabindex="-1"
                                                                                    aria-labelledby="exampleModalLabel"
                                                                                    aria-hidden="true">
                                                                                    <div
                                                                                        class="modal-dialog modal-xl modal-dialog-centered">
                                                                                        <div class="modal-content">
                                                                                            ...
                                                                                            <div class="modal-body">
                                                                                                <div id=""
                                                                                                    class="carousel slide carouselExampleIndicators_complex_complex_{{$v->id}}"
                                                                                                    data-bs-ride="carousel">
                                                                                                    <div
                                                                                                        class="carousel-indicators">
                                                                                                        <button
                                                                                                            type="button"
                                                                                                            data-bs-target=".carouselExampleIndicators_complex_complex_{{$v->id}}"
                                                                                                            data-bs-slide-to="0"
                                                                                                            class="active"
                                                                                                            aria-current="true"
                                                                                                            aria-label="Slide {{$v->id}}"></button>
                                                                    ...
                                                                    <div class="row mt-2 ">
                                                                        <div
                                                                            ...
                                                                            <div class="thumbnail view-more"
                                                                                ...
                                                                                <a href="" class="view-more-text small"
                                                                                    data-bs-toggle="modal"
                                                                                    data-bs-target="#advanced_{{$v->id}}">View
                                                                                    More</a>
                                                                                <!-- Modal -->
                                                                                <div class="modal fade"
                                                                                    id="advanced_{{$v->id}}" tabindex="-1"
                                                                                    aria-labelledby="exampleModalLabel"
                                                                                    aria-hidden="true">
                                                                                    <div
                                                                                        class="modal-dialog modal-xl modal-dialog-centered">
                                                                                        <div class="modal-content">
                                                                                            ...
                                                                                            <div class="modal-body">
                                                                                                <div id=""
                                                                                                    class="carousel slide carouselExampleIndicators_advanced_complex_{{$v->id}}"
                                                                                                    data-bs-ride="carousel">
                                                                                                    <div
                                                                                                        class="carousel-indicators">
                                                                                                        <button
                                                                                                            type="button"
                                                                                                            data-bs-target=".carouselExampleIndicators_advanced_complex_{{$v->id}}"
                                                                                                            data-bs-slide-to="0"
                                                                                                            class="active"
                                                                                                            aria-current="true"
                                                                                                            aria-label="Slide {{$v->id}}"></button>
                                                                                ...
                                                                                <div class="modal fade"
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <div class="modal-content">
                                                                                            ...
                                                                                            <div class="modal-body">
                                                                                                <div id=""
                                                                                                    class="carousel slide carouselExampleIndicators_super_complex_{{$v->id}}"
                                                                                                    data-bs-ride="carousel">
                                                                                                    <div
                                                                                                        class="carousel-indicators">
                                                                                                        <button
                                                                                                    ...
                                                                                                    <button
                                                                                                        class="carousel-control-prev"
                                                                                                        type="button"
                                                                                                        data-bs-target=".carouselExampleIndicators_super_complex_complex_{{$v->id}}"
                                                                                                        data-bs-slide="prev">
                                                                                                        <span
                                                                                                            class="carousel-control-prev-icon"
                                                                                                            aria-hidden="true"></span>
                        ...
                        <section class="px-2 mb-5">
                            ...
                            <div class="row mt-5">
                                ...
                                <div class="col-lg-12 mt-4">
                                    <label for="phone" class="form-label">WHAT'S YOUR PHONE?<span
                                        class="text-danger">*</span></label>
                                ...
                                <div class="col-lg-12 mt-4">
                                    <label for="email" class="form-label">WHAT'S YOUR ADDRESS?<span
                                        class="text-danger">*</span></label>
    ...
    <div class="modal" id="quickContactModalId">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <!-- Modal body -->
                <div class="modal-body">
                    <form id="quickContactFormId" action=""
                        method="post">
    ...
    <script src="{{asset('order/jquery-3.6.0.js')}}"></script>
    <script src="{{asset('order/popper.min.js')}}"></script>
    <script src="{{asset('order/bootstrap.js')}}"></script>
    <script src="{{asset('order/notify.min.js')}}"></script>
    <script src="{{asset('order/custom.js')}}"></script>
    <script>
    </script>
    <script>
           ...
           let seletcedMenu = parseInt(localStorage.getItem('sideBarMenu'));
            ...
            if(seletcedMenu === 3){
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if(data.status=='success'){
                                ...
                                sessionStorage.setItem("orderSuccess", "success")
                                //  $.session("orderSuccess","success")
                ...
                $(document).on('click','.backToIndex',function(){
                    $(location).attr('href', "{{ route('indexf')}}")
                })
            }
        }
