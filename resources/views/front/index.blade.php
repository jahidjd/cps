                ...
                <div class="elementor-column-wrap elementor-element-populated">
                    <div class="elementor-widget-wrap">
                        <div class="elementor-element elementor-element-d50dcff elementor-widget elementor-widget-heading"
                            ...
                            <div class="elementor-widget-container">
                                <h2 class="elementor-heading-title elementor-size-xl"><a href="#">{{$v->title}}</a></h2>
                            </div>
                        </div>
                            ...
                            <div class="elementor-element elementor-element-c16f27a elementor-widget elementor-widget-image"
                                ...
                                <div class="elementor-widget-container">
                                    <div class="elementor-image">
                                        <img decoding="async" width="800" height="400"
                                            src="{{url('aminAsset/image/service/',$v->image)}}"
                                            class="attachment-large size-large wp-image-11111" alt="{{$v->title}}"
                        ...
                        <div class="elementor-widget-wrap">
                            <div class="elementor-element elementor-element-95d1b16 elementor-widget elementor-widget-image"
                                ...
                                <div class="elementor-widget-container">
                                    <div class="elementor-image">
                                        <a href="#">
                                            <img decoding="async" width="1124" height="216" src=""
                    ...
                    <div class="elementor-column-wrap elementor-element-populated">
                        <div class="elementor-widget-wrap">
                            <div class="elementor-element elementor-element-5e548ac elementor-widget elementor-widget-spacer"
                                data-id="5e548ac" data-element_type="widget" data-widget_type="spacer.default">
                                <div class="elementor-widget-container">
                                    <div class="elementor-spacer">
                                        <div class="elementor-spacer-inner"></div>
                                    </div>
                            ...
                            <div class="elementor-element elementor-element-5a3614d elementor-widget elementor-widget-heading"
                                data-id="5a3614d" data-element_type="widget" data-widget_type="heading.default">
                                <div class="elementor-widget-container">
                            ...
                            <div class="elementor-element elementor-element-e8a049d elementor-widget elementor-widget-text-editor"
                                data-id="e8a049d" data-element_type="widget" data-widget_type="text-editor.default">
                                <div class="elementor-widget-container">
                                    <div class="elementor-text-editor elementor-clearfix">
                                ...
                                <div class="elementor-container elementor-column-gap-default">
                                    <div class="elementor-row">
                                        ...
                                        @if ($k>0 && $k<5) <div
                                            ...
                                            <div class="elementor-column-wrap elementor-element-populated">
                                                <div class="elementor-widget-wrap">
                                                    <div class="elementor-element @if($k==1) elementor-element-bec7929 @elseif($k==2) elementor-element-7fe8b53 @elseif($k==3) elementor-element-b7d2b9f @elseif($k==4) elementor-element-ed1301f @else elementor-element-65e739e @endif  elementor-widget elementor-widget-image"
                                                        data-id="7fe8b53" data-element_type="widget"
                                                    ...
                                                    <div class="elementor-element elementor-element-bf28852 elementor-widget elementor-widget-text-editor"
                                                        data-id="bf28852" data-element_type="widget"
                                                        data-widget_type="text-editor.default">
                                                        <div class="elementor-widget-container">
                                                            <div class="elementor-text-editor elementor-clearfix">
                                                                <p>{{$v->title}}</p>
                    ...
                    <div class="elementor-column-wrap elementor-element-populated">
                        <div class="elementor-widget-wrap">
                            <div class="elementor-element elementor-element-65e739e elementor-widget elementor-widget-text-editor"
                                data-id="65e739e" data-element_type="widget" data-widget_type="text-editor.default">

                            </div>
                            <div class="elementor-element elementor-element-489ed7f elementor-align-center elementor-widget elementor-widget-button"
                                data-id="489ed7f" data-element_type="widget" data-widget_type="button.default">
                                <div class="elementor-widget-container">
                                    <div class="elementor-button-wrapper">
                    ...
                    <div class="elementor-column-wrap elementor-element-populated">
                        <div class="elementor-widget-wrap">
                            ...
                            <div class="elementor-element elementor-element-ce3c801 elementor-widget elementor-widget-heading"
                                ...
                                <div class="elementor-widget-container">
                                    <h3 class="elementor-heading-title elementor-size-xl">{{$best->title}}</h3>
                                </div>
                            </div>
                                                ...
                                                <dt class='gallery-icon landscape'>
                                                    <a data-elementor-open-lightbox="yes"
                                                        ...
                                                        href='{{url(' aminAsset/image/works/',$v->image)}}'><img
                                                            ...
                                                            class="attachment-full size-full" alt="{{$v->title}}"
                                                            decoding="async" aria-describedby="gallery-1-10713"
                            ...
                            <section
                                ...
                                <div class="elementor-container elementor-column-gap-default">
                                    <div class="elementor-row">
                                        ...
                                        @if ($k<3) <div
                                            class="elementor-column elementor-col-33 elementor-inner-column elementor-element elementor-element-9f6961e"
    ...
    <section
        ...
        <div class="elementor-container elementor-column-gap-default">
            <div class="elementor-row">
                ...
                @if ($k<8) <div
                    class="elementor-column elementor-col-12 elementor-inner-column elementor-element elementor-element-58ec7db animated-slow elementor-invisible"
                    ...
                    <div class="elementor-column-wrap elementor-element-populated">
                        <div class="elementor-widget-wrap">
                            <div class="elementor-element elementor-element-ba5e137 elementor-widget elementor-widget-image"
                                ...
                                <div class="elementor-widget-container">
                                    <div class="elementor-image">
                                        <img decoding="async" width="250" height="250" src=""
                                            ...
                                            data-lazy-src="{{url('aminAsset/image/clientsLogo/',$v->image)}}" /><noscript><img
                                                decoding="async" width="250" height="250" alt="{{$v->title}}"
