                            ...
                            <div class="elementor-widget-container">
                                <div class="elementor-image">
                                    <img decoding="async" width="800" height="400"
                                        ...
                                        class="attachment-large size-large wp-image-10832" alt="Complex-Clipping-Path"
                                ...
                                <div class="elementor-widget-container">
                                    <div class="elementor-image">
                                        <img decoding="async" width="800" height="400"
                                            ...
                                            alt="E-commerce-Photo-Neck-joint"
                                    ...
                                    <div class="elementor-image">
                                        <a href="contact-us/index.html">
                                            <img decoding="async" width="1124" height="216"
                                                ...
                                                class="attachment-full size-full wp-image-16128" alt="3D Service Banner"
                                            ...
                                            @if ($k<6) <dl class='gallery-item'>
                                                <dt class='gallery-icon landscape'>
                                                    <a data-elementor-open-lightbox="yes"
                                                        ...
                                                        data-elementor-lightbox-title="After-Photo-Manipulation"
                                                        e-action-hash="#elementor-action%3Aaction%3Dlightbox%26settings%3DeyJpZCI6MTA3MTMsInVybCI6Imh0dHBzOlwvXC90aGVjbGlwcGluZ3BhdGhzZXJ2aWNlLmNvbVwvd3AtY29udGVudFwvdXBsb2Fkc1wvMjAxOVwvMTBcL0FmdGVyLVBob3RvLU1hbmlwdWxhdGlvbi5qcGciLCJzbGlkZXNob3ciOiI2YTY0NmEzMSJ9"
                                                        href='{{url(' aminAsset/image/works/',$v->image)}}'><img
                                                            width="950" height="615"
                                                            src="{{url('aminAsset/image/works/',$v->image)}}"
                                                            class="attachment-full size-full"
                                                            alt="After-Photo-Manipulation" decoding="async"
