...
<link data-minify="1" rel='preload'  href='{{asset('assets/plugins/elementor/assets/css/post-12035.css')}}' data-rocket-async="style" as="style" onload="this.onload=null;this.rel='stylesheet'" type='text/css' media='all' />
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <img width="100"
                                                                                                                height="100"
                                                                                                                decoding="async"
                                                                                                                src="data:image/svg+xml,%3Csvg%20xmlns='{{url('transfer.png')}}"
                                                                                                                title="We-transfer icon"
                                                                                                                alt="We-transfer icon"
                                                                                                                data-lazy-src="{{url('transfer.png')}}" /><noscript><img
                                                                                                                    width="100"
                                                                                                                    height="100"
                                                                                                                    decoding="async"
                                                                                                                    src="{{url('transfer.png')}}"
                                                                                                                    title="We-transfer icon"
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <img width="100"
                                                                                                                height="100"
                                                                                                                decoding="async"
                                                                                                                src="data:image/svg+xml,%3Csvg%20xmlns='{{url('Dopbox.png')}}"
                                                                                                                title="Dopbox icon"
                                                                                                                alt="Dopbox icon"
                                                                                                                data-lazy-src="{{url('Dopbox.png')}}" /><noscript><img
                                                                                                                    width="100"
                                                                                                                    height="100"
                                                                                                                    decoding="async"
                                                                                                                    src="{{url('Dopbox.png')}}"
