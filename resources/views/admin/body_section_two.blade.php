            ...
            <div class="col-xl-12 col-lg-12">
                ...
                <div class="card mb-12">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{route('addBodySectionTwo')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <tbody>
                                @forelse ($d as $k=>$v)
                                    <tr>
                                        ...
                                        <td>{{$v->description}}</td>
                                        <td>
                                            <img src="{{url('aminAsset/image/bodySectionTwo/',$v->image)}}" alt="">
                                        </td>
                                        <td>{{$v->status}}</td>
                                        
                                        <td>
                                            <a href="{{route('editSectionTwo',$v->id)}}" style="color: yellowgreen" class="btn"><i class="fas fa-edit"></i></a>
                                            <form action="{{route('deleteSectionTne',$v->id)}}" method="post">
                                            @csrf
                                            @method('delete')
