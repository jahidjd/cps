            ...
            <div class="col-xl-12 col-lg-12">
                ...
                <div class="card mb-12">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{route('addpricing')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <th>Button Text</th>
                                    <th><input type="text" name="button_text" class="form-control"></th>
                                </tr>
                                <tr>
                                   <td  colspan="2"></td>
                            ...
                            <tbody>
                                @forelse ($l as $k=>$v)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('editPricing',$v->id)}}" style="color: yellowgreen" class="btn"><i class="fas fa-edit"></i></a>
                                            <form action="{{route('deletePricing',$v->id)}}" method="post">
                                            @csrf
                                            @method('delete')
