        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12">
                ...
                <div class="card mb-12">
                    ...
                    <div class="card-body">
                        <h1>Body Section One</h1>
                        @if ($message = Session::get('success'))
                            <div class="alert alert-success">
                                <strong>{{ $message }}</strong>
                            </div>
                        @endif
                        <form action="{{route('addBodySectionOne')}}" method="post">
                            @csrf
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <th><input type="submit" value="Submit" class="btn form-control" style="color: greenyellow"></th>
                            ...
                            <tbody>
                                @forelse ($d as $k=>$v)
                                    <tr>
                                        ...
                                        <td>
                                            <br>
                                            <a href="{{route('editSectionOne',$v->id)}}" style="color: yellowgreen" class="btn"><i class="fas fa-edit"></i></a>
                                            <form action="{{route('deleteSectionOne',$v->id)}}" method="post">
                                            @csrf
                                            @method('delete')
