        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12">
                ...
                <div class="card mb-12">
                    ...
                    <div class="card-body">
                        <h1>Body Section One Update</h1>
                        <form action="{{route('updateBodySectionThree',$d->id)}}" method="post">
                            @csrf
                            @method('put')
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <th><input type="submit" value="Update" class="btn form-control" style="color: greenyellow"></th>
