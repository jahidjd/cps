            ...
            <div class="menu">
                ...
                <div class="menu-item has-sub">
                    ...
                    <div class="menu-submenu">
                        ...
                        <div class="menu-item">
                            <a href="{{route('serviceImage')}}" class="menu-link">
                                <span class="menu-text">Service Image</span>
                            </a>
                        </div>
                ...
                <div class="menu-item">
                    <a href="{{route('metaTable')}}" class="menu-link">
                        <span class="menu-icon"><i class="bi bi-gem"></i></span>
                ...
                <div class="menu-item">
                    <a href="{{route('customer_review')}}" class="menu-link">
                        <span class="menu-icon"><i class="bi bi-gem"></i></span>
                        <span class="menu-text">Customer Review</span>
                    </a>
                </div> 
                <div class="menu-item">
                    <a href="{{route('clientCompany')}}" class="menu-link">
                        <span class="menu-icon"><i class="bi bi-gem"></i></span>
                        <span class="menu-text">Client Companies Logos</span>
                    </a>
                </div> 
            </div>
