        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12">
                ...
                <div class="card mb-12">
                    ...
                    <div class="card-body">
                        <h1>Body Section Three</h1>
                        @if ($message = Session::get('success'))
                        <div class="alert alert-success">
                            <strong>{{ $message }}</strong>
                        </div>
                        @endif
                        <form action="{{route('addBodySectionThree')}}" method="post">
                            @csrf
        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12">
                ...
                <div class="card mb-12">
                    ...
                    <div class="card-body">
                        <h1>Body Section Three Table</h1>
                        <table class="table table-bordered display " id="datatableDefault">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <br>
                                        <a href="{{route('editSectionThree',$v->id)}}" style="color: yellowgreen"
                                            class="btn"><i class="fas fa-edit"></i></a>
                                        <form action="{{route('deleteSectionThree',$v->id)}}" method="post">
                                            @csrf
                                            @method('delete')
