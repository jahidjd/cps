...
class FrontController extends Controller
{
    function index(){
        ...
        return view('front.index',compact('s','seo','general','slider','bodyOne','bodyOneT','bodyTwoT','bodyTwo','serviceT','service','homePricing','homePricingT','works','socialMedia','bodySectionThree','bodySectionThreeT'));
    }
    function about_us(){
        $general = General::first();
        $socialMedia = SocialMedia::first();
    ...
    function workPortfolio(){
        ...
        $seo = Seo::first();
        $s = ServiceDetails::get();
        return view('front.workPortfolio',compact('general','works','socialMedia','seo','s'));
    }
    function pricings(){
        $general = General::first();
    ...
    function serviceDetails($id){
        ...
        $seo = Seo::first();
        $s = ServiceDetails::get();
        return view('front.serviceDetailss',compact('s','general','service','socialMedia','bodySectionTwo','works','seo'));
    }
    function serviceChoose(){
        ...
        return view('front.serviceChoose',compact('s','general','socialMedia','price','seo','image'));
    }
