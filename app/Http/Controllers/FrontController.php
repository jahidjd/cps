...
class FrontController extends Controller
{
    function index(){
        ...
        $bodyTwo = BodySectionTwo::where('status','active')->get();
        $service = Service::where('status','active')->get();
        $serviceT = Service::where('status','active')->get();
        $homePricing = HomePricing::where('status','active')->get();
        $homePricingT = HomePricing::where('status','active')->get();
        $socialMedia = SocialMedia::first();
        $bodySectionThree = BodySectionThree::first();
        $bodySectionThreeT = BodySectionThree::latest()->get();
        $works = Works::where('status','active')->get();
        $seo = Seo::first();
        $best = BodySectionFour::first();
        ...
        return view('front.index',compact('best','cLogo','customer','s','seo','general','slider','bodyOne','bodyOneT','bodyTwoT','bodyTwo','serviceT','service','homePricing','homePricingT','works','socialMedia','bodySectionThree','bodySectionThreeT'));
    }
    function about_us(){
        $general = General::first();
        $socialMedia = SocialMedia::first();
    ...
    function pricings(){
        $general = General::first();
        $pricing = Pricing::where('status','active')->get();
        $socialMedia = SocialMedia::first();
        $seo = Seo::first();
        $s = ServiceDetails::get();
