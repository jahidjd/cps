...
Route::controller(FrontController::class)->group(function(){
    ...
    Route::get('/choose-service/{id}','serviceChoose')->name('serviceChoose');
    Route::post('/serviceAdd','serviceAdd')->name('serviceAdd');
    Route::post('/addFreeTrial','addFreeTrial')->name('addFreeTrial');
});
Route::controller(AdminController::class)->group(function(){
    ...
    Route::get('/free-trials','freeTrailList')->name('freeTrailList');
    Route::get('/meta-table','metaTable')->name('metaTable');
    Route::post('/addMeta','addMeta')->name('addMeta');
    Route::get('/editMeta/{id}','editMeta')->name('editMeta');
    Route::put('/updateMeta','updateMeta')->name('updateMeta');
    Route::delete('/deleteMeta/{id}','deleteMeta')->name('deleteMeta');
    Route::get('/order-list','order')->name('order');
    Route::get('/orderDetails/{id}','orderDetails')->name('orderDetails');
    Route::get('/serviceImage','serviceImage')->name('serviceImage');
    Route::post('/addServiceImage','addServiceImage')->name('addServiceImage');
    Route::get('/editServiceImage/{id}','editServiceImage')->name('editServiceImage');
    Route::put('/updateServiceImage/{id}','updateServiceImage')->name('updateServiceImage');
    Route::delete('/deleteServiceImage/{id}','deleteServiceImage')->name('deleteServiceImage');
    Route::get('/orderStatus/{id}','orderStatus')->name('orderStatus');
    Route::get('/customer-review','customer_review')->name('customer_review');
    Route::get('/client-company','clientCompany')->name('clientCompany');
    Route::post('/addClients','addClients')->name('addClients');
    Route::get('/editcl/{id}','editcl')->name('editcl');
    Route::put('/updateCDL/{id}','updateCDL')->name('updateCDL');
    Route::delete('/deletecl/{id}','deletecl')->name('deletecl');
    Route::post('/addCustomerReview','addCustomerReview')->name('addCustomerReview');
    Route::get('/editCustomerReview/{id}','editCustomerReview')->name('editCustomerReview');
    Route::put('/updateCustomerReview/{id}','updateCustomerReview')->name('updateCustomerReview');
    Route::delete('/deleteCustomerReview/{id}','deleteCustomerReview')->name('deleteCustomerReview');
    Route::delete('/deleteOrder/{id}','deleteOrder')->name('deleteOrder');
    Route::get('/why-best','whyBest')->name('whyBest');
    Route::put('/updateBest/{id}','updateBest')->name('updateBest');
